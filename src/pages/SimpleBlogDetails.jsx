        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <h3 className="text-2xl font-bold mb-4">CygneNoir Cyber</h3>
              <p className="text-gray-300 mb-4">
                Leading cybersecurity insights and AI-powered threat intelligence for modern organizations.
              </p>
              <p className="text-gray-400 text-sm">
                © 2024 CygneNoir. All rights reserved.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><a href="#" className="hover:text-white transition-colors">Threat Protection</a></li>
