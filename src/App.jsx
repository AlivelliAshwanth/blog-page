  ...
  return (
    <nav className="bg-white border-b border-gray-200 text-gray-900 p-3 sticky top-0 z-50 backdrop-blur-sm shadow-sm">
      <div className="flex justify-between items-center px-4">
        <a href="https://www.cygnenoircyber.com" className="flex items-center gap-2 text-xl font-black text-gray-900 hover:text-blue-600 transition-colors duration-300">
          <img 
            src="/logo.png" 
            alt="Cygne Noir Cyber Logo" 
            className="w-12 h-9 rounded-lg shadow-lg object-contain border border-black"
          />
          <div>
        ...
        <div className="space-x-8">
          <a href="https://www.cygnenoircyber.com" className="text-gray-600 hover:text-blue-600 transition-colors duration-300 font-bold uppercase tracking-widest text-sm">HOME</a>
          <Link to="/" className="text-gray-600 hover:text-blue-600 transition-colors duration-300 font-bold uppercase tracking-widest text-sm">BLOG</Link>
        </div>
      </div>
    </nav>
  );
